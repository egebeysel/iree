...
// consult the hint (only linalg.pack/unpack do); the overloads exist so that the
// ops -- which list the hint-less method in DeclareOpInterfaceMethods -- also
// define the defaulted hint-bearing arity and avoid C++ name hiding.
...
// Additional hint-bearing TilingInterface overloads (ops added/extended since the
// base of the InnerTileAlignment work). These ops ignore the hint.
