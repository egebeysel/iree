...
struct CPULayoutResolverAttr final
  ...
  Attribute cloneWithSimplifiedConfig(Attribute attr,
    ...
    /*if (isAArch64(config) && (hasFeature(config, "+sve") || hasFeature(config,
    "+sve2"))) { NamedAttribute transposeHint{StringAttr::get(ctx,
    "transpose_hint"), StringAttr::get(ctx, "0")};
      configItems.push_back(transposeHint);
    }*/
